...
const EXPERIMENTS = [
  {
    ...
    problem: "New users face high friction when forced to purchase coins before experiencing the core value of the platform. This creates a massive drop-off funnel before they even complete their first voice call.",
    hypothesis: "By offering the very first call for free alongside a listener preview, users instantly hit the 'Aha!' moment. Experiencing the value firsthand will drastically improve wallet activation and overall conversion rates.",
  ...
  },
  {
    ...
    problem: "When users are randomly matched outside their cultural or linguistic background, conversations feel disconnected and awkward, leading to severely shortened call durations and poor satisfaction.",
    hypothesis: "Introducing robust geographic and language filters ensures users connect with familiar voices from their own region. Highly relevant, comfortable matches will maximize average session length and downstream retention.",
  ...
  },
  {
    ...
    problem: "The core loop relies entirely on 1-on-1 calls. On days when users don't have the energy to actively call someone, they simply don't open the app, leading to low daily engagement and churn.",
    hypothesis: "Deploying passive Live Video Streams alongside an active Daily Streak will create a low-friction daily habit. Users can casually hang out, earn rewards, and stay engaged without being forced into direct calls.",

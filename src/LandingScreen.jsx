...
const EXPERIMENTS = [
  {
    ...
    problem: "Paywalls block users before they experience the app's value.",
    hypothesis: "A free first call drives instant 'Aha!' moments and boosts conversion.",
  ...
  },
  {
    ...
    problem: "Random matches lead to awkward language barriers and short calls.",
    hypothesis: "Local filters ensure comfortable chats, boosting retention.",
  ...
  },
  {
    ...
    problem: "Users churn on days they lack energy for 1-on-1 calls.",
    hypothesis: "Passive streams and streaks create a low-friction daily habit.",

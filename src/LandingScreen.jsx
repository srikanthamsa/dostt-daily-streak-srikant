...
const EXPERIMENTS = [
  {
    ...
    problem: "Forcing users to buy coins before they experience the app's value causes a massive drop-off before their first call.",
    hypothesis: "Offering a free first call lets users hit the 'Aha!' moment instantly, driving higher wallet activation and purchases.",
  ...
  },
  {
    ...
    problem: "Random matches often lead to cultural or language barriers, resulting in awkward, short conversations and poor satisfaction.",
    hypothesis: "Local city and language filters match users with familiar voices, leading to deeper conversations and stronger D7 retention.",
  ...
  },
  {
    ...
    problem: "On days users don't have the energy for 1-on-1 voice calls, they simply don't open the app, leading to churn.",
    hypothesis: "Live video streams and daily streak rewards create a low-friction habit, letting users hang out passively and boosting DAU.",
